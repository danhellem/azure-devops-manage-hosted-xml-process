...
namespace ImportExportProcessExamples
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            {
                "/action:importone",
                "/processid:ADCC42AB-9882-485E-A3ED-7678F01F66A",
                "/source:" + @"C:\Temp\MyAgile.zip"
            };
        ...
        public static void ShowHelp()
        {
            ...
            Console.ForegroundColor = ConsoleColor.Cyan;
            Console.WriteLine("Project XmlProcess");
            ...
            //Console.ForegroundColor = ConsoleColor.Cyan;
            //Console.Write("XmlProcess /action:");
            //Console.ForegroundColor = ConsoleColor.Gray;
            //Console.Write("[value] ");
            //Console.ForegroundColor = ConsoleColor.Cyan;
