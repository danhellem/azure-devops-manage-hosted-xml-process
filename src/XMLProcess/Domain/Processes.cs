...
using XmlProcess.ViewModels;
using System.IO;
using System.IO.Compression;
using System.Net.Http.Formatting;
using Newtonsoft.Json;

namespace XmlProcess.Domain
{
    public class Processes
    {       
        //string _apiurl = "https://privatepreview.visualstudio.com/defaultCollection/";
        //string _login = Convert.ToBase64String(System.Text.ASCIIEncoding.ASCII.GetBytes(string.Format("{0}:{1}", "dan_hellem@hotmail.com", "45ifi3cxef3wz4n2pwk5ooijxxljvltx7nebf3yjkmif5a4gzcia")));
